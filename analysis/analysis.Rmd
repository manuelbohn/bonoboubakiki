...
Figure \@ref(fig:rtplot) visualizes the reaction times by correct choice and trial type. Responses seemed to be faster in test trials, but the two distributions still overlap considerably. 
