...
sim_res_100 <-readRDS("saves/sim_100_p65.rds") # sd for word and shape_comb variation based on model for human implicit data, 100 trials
sim_res_300 <-readRDS("saves/sim_300_p65.rds") # sd for word and shape_comb variation based on model for human implicit data, 300 trials
sim_res_600 <-readRDS("saves/sim_600_p65.rds") # sd for word and shape_comb variation based on model for human implicit data, 600 trials
sim_res_900 <-readRDS("saves/sim_900_p65.rds") # sd for word and shape_comb variation based on model for human implicit data, 900 trials
